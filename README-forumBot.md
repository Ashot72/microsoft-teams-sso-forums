...
3. Give the bot a handle (ex: `forumBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://forum.azurewebsites.net/api/messages`
